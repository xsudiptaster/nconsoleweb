...
import MoveApexClassPermissionView from "./MoveApexClassPermissionView";
import "./style.css";
            ...
            <table className="styled-table">
               <thead>
                  <tr>
                     ...
                     <th style={{ borderLeft: "2px black solid", borderRight: "2px black solid" }}>
                  ...
                  <tr>
                     <th style={{ borderLeft: "2px black solid", borderRight: "2px black solid" }}>Enabled</th>
                     <th>
                        <MoveApexClassPermissionView />
                     </th>
                  ...
                  {keys
                     ...
                     .map((key) => {
                        return (
                           ...
                           >
                              <td>{key}</td>
                              <td style={{ borderLeft: "2px black solid", borderRight: "2px black solid" }}>
