...
import MoveFieldPermissionView from "./MoveFieldPermissionView";
import "./style.css";
            ...
            <table className="styled-table">
               <thead>
                  ...
                  <tr>
                     ...
                     <th>
                        <MoveFieldPermissionView selectedObjects={selectedObjects} />
                     </th>
                     <th
                        style={{
                           borderLeft: "2px black solid",
                                 ...
                                 .map((f: any) => {
                                    return (
                                       <tr
                                          key={f}
                                          style={{
                                             color: handleComparisionFieldLevel(fieldPermissions, key.objectName, f)
                                                ? "green"
                                                : "#BF0000",
                                          }}
                                       >
                                          ...
                                          >
                                             <GetPermissionsFieldCompareView
                                                perm="readable"
                                                prof="A"
                                                obj={key.objectName}
                                                field={f}
                                          ...
                                          <td>
                                             <MoveFieldPermissionView selectedObjects={selectedObjects} field={f} />
                                          </td>
                                          <td
                                             style={{
                                                borderLeft: "2px black solid",
