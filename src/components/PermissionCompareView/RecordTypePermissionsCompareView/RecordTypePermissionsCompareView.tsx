...
import MoveRecordTypePermissionsView from "./MoveRecordTypePermissionsView";
         ...
         <table className="styled-table">
            <thead>
               <tr>
                  ...
                  <th colSpan={2} style={{ borderLeft: "2px black solid", borderRight: "2px black solid" }}>
                           ...
                           .map((recordType: string) => {
                              return (
                                 <tr
                                    key={recordType}
                                    style={{
                                       color: handleComparision(recordTypePermissions, key.recordTypeName, recordType)
                                          ? "green"
                                          : "#BF0000",
                                    }}
                                 >
                                    <td>{recordType.split(".")[1]}</td>
                                    <td style={{ borderLeft: "2px black solid" }}>
                                       <GetPermissionsRecordTypeCompareView
                                          prof="A"
                                          obj={key.recordTypeName}
                                          r={recordType}
                                          perm="visible"
                                       />
                                    </td>
                                    ...
                                    <td>
                                       <MoveRecordTypePermissionsView recordTypeName={recordType} />{" "}
                                    </td>
                                    <td style={{ borderLeft: "2px black solid" }}>
                                       <GetPermissionsRecordTypeCompareView
                                          prof="B"
