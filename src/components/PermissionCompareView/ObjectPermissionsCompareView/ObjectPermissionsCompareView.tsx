...
import { handleComparision, handleLoad } from "./ObjectPermissionsCompareView.util";
          ...
          <table className="styled-table">
            <thead>
              <tr>
                ...
                <th colSpan={6} style={{ borderLeft: "2px black solid" }}>
              ...
              {keys
                ...
                .filter((key) => {
                  return selectedFilter === "All"
                    ? true
                    : selectedFilter === "Same"
                    ? handleComparision(objectPermissions, key)
                    : !handleComparision(objectPermissions, key);
                })
                .map((key: string) => {
                  return (
                    <tr
                      key={key}
                      style={{
                        color: handleComparision(objectPermissions, key) ? "green" : "#BF0000",
                      }}
                    >
                      <td>{key}</td>
                      <td
