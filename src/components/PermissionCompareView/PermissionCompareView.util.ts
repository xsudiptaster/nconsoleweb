...
export const handleSave = async (
  ...
  console.log("🚀 ~ file: PermissionComparisionView.util.ts:210 ~ packageJSON:", packageJSON, profileOption);
  let response = await handleApiSecond("metadataUpsert", loginInfo, { metadataType: profileOption.type, records: [packageJSON] });
  console.log("🚀 ~ file: PermissionComparisionView.util.ts:212 ~ response:", response);
  return response;
};
